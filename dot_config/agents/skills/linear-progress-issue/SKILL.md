...
description: Coordinate one medium-effort subagent to progress an issue previously verified by `linear-link-work` through Backlog, Todo, In Progress, and Done, or cancel it when explicitly requested. Use after linking when planning, starting, completing, or canceling repository work.
---
